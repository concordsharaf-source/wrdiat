const APP_CONFIG = {
  ...
  // رمز الدولة الافتراضي (المفتاح) لأرقام الواتساب: إن سجّل شخص رقمه بدون رمز الدولة
  // يُضاف تلقائياً عند فتح الواتساب حتى لا يظهر الرقم برمز دولة خاطئ — غيّره حسب بلدك.
